...
@section('content')
    <main id="blog" class="overflow-hidden">
        ...
        <section class="pb-2 pb-lg-4 mt-0">
            <div class="d-block video-slide swiper-slide card-detalhe mb-1">
                <div class="ratio ratio-md-28 ratio-70 overflow-hidden" style="" data-aos="zoom-out-up">
                    <div class="z-index-1" style="background: linear-gradient(90deg, #202020 0%, rgba(32, 32, 32, 0) 100%);
                    opacity: 0.9;"></div>
                    <img class="w-100 h-100 object-fit-cover" src="{{ url("/front/images/backgrounds/blog-detalhe.png") }}" alt="Icone">
                    <div class="z-index-2" style="">
                        <div class="position-absolute bottom-0 start-0 p-1 position-conteudo col-lg-6 d-flex">
                            <div>
                                ...
                                <p class="fs-16 fw-400 text-white d-none d-md-block mt-1">
            ...
            <div class="container" data-aos="zoom-out-up">
                <div class="row gy-2 justify-content-center text-center text-lg-start">
                    <div class="col-12 col-lg-8">
                            <small class="text-muted mb-1 d-block">Data: 20/03/2023</small>
                        <div class="mb-1">
                            <h1 class="h4 text-dark fw-bold mb-0">Título</h1>
                        </div>
                    ...
                    <div class="col-12 col-lg-8">
                        <div class="d-flex gap-1 gap-lg-3 align-items-center flex-wrap flex-column-reverse flex-lg-row">
                            <a href="{{ route_lang('blog') }}" class="rounded-0 btn btn-dark w-max mt-1 mt-sm-0">Voltar</a>
                            <div class="d-flex flex-column flex-lg-row gap-0-50 align-items-center flex-wrap">
                                ...
                                <div class="d-flex gap-0-50 align-items-center">
                                    <a class="d-flex rounded-0 btn btn-outline-dark p-0-50" title="Compartilhe no WhatsApp" href="https://api.whatsapp.com/send?text=" target="_blank" aria-label="Whatsapp">
                                    ...
                                    <a class="d-flex rounded-0 btn btn-outline-dark p-0-50" title="Compartilhe no Facebook" href="https://www.facebook.com/sharer/sharer.php?u=" target="_blank" aria-label="Facebook">
